...
<jsp:include page="/WEB-INF/jsp/parts/html-head.jsp">
    <jsp:param name="titleText" value=" - Privacy" />
    <jsp:param name="descriptionText" value="Privacy policy." />
</jsp:include>
<body>

<div data-role="page" id="page-privacy">
    ...
    <div data-role="content">
        ...
        <p>This privacy policy sets out how Matt Burns Ltd uses and protects any information
        that you give Matt Burns Ltd when you use this website www.oddprints.com.</p>
        
        <p>Matt Burns Ltd is committed to ensuring that your privacy is protected.
        ...
        <p>Matt Burns Ltd may change this policy from time to time by updating this page.
        ...
        <li>other information relevant to placed photos orders</li>
        </ul>
        ...
        <ul class="dotted">
            ...
            <li>we may use the information to improve our service</li>
            <li>we may periodically send emails about upgrades
            or other information which we think you may find interesting
            using the email address which you have provided</li>
            <li>from time to time, we may also use your information
            to contact you by email for market research purposes</li>
        ...
        electronic procedures to safeguard and secure the information we collect online.</p>
        ...
        <p>We use traffic log cookies to identify which pages are being used. We use Google Analytics to
        identify which pages are being used. Google Analytics generates statistical and other
        ...
        <p>This privacy policy only applies to information collected on www.oddprints.com.
        Our website may contain links to other websites. Once you have used these links to leave our site,
        you should note that we do not have any control over that other website. Therefore, we cannot
        be responsible for the protection and privacy of any information which you provide whilst visiting
        such sites and such sites are not governed by this privacy statement. You should exercise caution
        and look at the privacy statement applicable to the website in question.</p>
        ...
        Data Protection Act 1998. If you would like a copy of the information held on you please
        email <a href="mailto:matt@oddprints.com">matt@oddprints.com</a>.</p>
        
        <p>If you believe that any information we are holding on you is incorrect or incomplete,
        please email us as soon as possible at the above address. We will promptly correct any information
        found to be incorrect.</p>
        
        <h3>Contact us</h3>
        
        <p>If you have any questions about this policy or our site in general,
        please contact us at <a href="mailto:matt@oddprints.com">matt@oddprints.com</a>.</p>
    </div>
