...
<div data-role="page" id="page-intro">
    ...
    <div data-role="content">
        ...
        <div class="supported-browser">
            <p><a href="#page-upload" data-role="button" data-theme="b" data-icon="arrow-r" data-iconpos="right">Get Started!</a></p>
        </div>
...
<div data-role="page" id="page-upload">
    ...
    <div data-role="content">
        <article>
            ...
            <p>Or just play with the <a id="sample-photo-link" href="#page-main" >sample photo</a>.</p>
...
<div data-role="page" id="page-main">
    ...
    <div data-role="content">        
        ...
        <form action="#" method="get">
            ...
            <div class="text-align-right">
                <a href="/#page-upload">change picture</a>
            </div>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <a href="#" id="img-link" data-role="button" data-theme="b" download="image.jpeg">Download</a>
