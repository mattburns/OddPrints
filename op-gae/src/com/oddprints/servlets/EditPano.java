...
public class EditPano {
    ...
    public Viewable loadBasicSample(@Context HttpServletRequest req)
        ...
        req.setAttribute("panoMode", Boolean.TRUE);
        // forward to normal servlet
        return edit.viewSampleImage(req, Settings.SAMPLE_PANO_BLOB_KEY,
                Settings.SAMPLE_PANO_BLOB_SIZE, new URL(
                        "http://www.oddprints.com/images/pano.jpg"));
    }
}
