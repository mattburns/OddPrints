...
public class ApplicationSetting {
    ...
    public enum Settings {
        APPLICATION_ENVIRONMENT, PWINTY_MERCHANT_ID_SANDBOX, PWINTY_MERCHANT_KEY_SANDBOX, PWINTY_MERCHANT_ID_LIVE, PWINTY_MERCHANT_KEY_LIVE, GOOGLE_CHECKOUT_MERCHANT_KEY_SANDBOX, GOOGLE_CHECKOUT_MERCHANT_ID_SANDBOX, GOOGLE_CHECKOUT_MERCHANT_KEY_LIVE, GOOGLE_CHECKOUT_MERCHANT_ID_LIVE, SAMPLE_PHOTO_BLOB_KEY, SAMPLE_PHOTO_BLOB_SIZE, SAMPLE_PANO_BLOB_KEY, SAMPLE_PANO_BLOB_SIZE, CHECKOUT_WARNING, GOODWILL;
    }
